...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="shebeishenqingList.do" name="myform" method="post">
    ...
    <td align='center'>${u.issh} <input type="button" value="审核" onClick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=shebeishenqing'"/></td>
                              ...
                              <td align="center"><a href="doUpdateShebeishenqing.do?id=${u.id }">回复</a>  <a href="deleteShebeishenqing.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="shebeishenqingList.do?page=1" >首页</a>
             <a href="shebeishenqingList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shebeishenqingList.do?page=${page.page+1 }">下一页</a>
			<a href="shebeishenqingList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
