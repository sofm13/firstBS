...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">设备申请列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="shebeishenqingList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.bianhao}</td>    <td>${u.shebeimingcheng}</td>    <td>${u.shenqingshuliang}</td>    <td>${u.shenqingyuanyin}</td>    <td>${u.jujueyuanyin}</td>        <td>${u.shenqingbumen}</td>    <td>${u.shenqingren}</td>    <td align='center'>${u.issh} </td>
                              ...
                              <td align="center"><a href="doUpdateShebeishenqing.do?id=${u.id }">编辑</a>  <a href="deleteShebeishenqing.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="shebeishenqingDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="shebeishenqingList2.do?page=1" >首页</a>
             <a href="shebeishenqingList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shebeishenqingList2.do?page=${page.page+1 }">下一页</a>
			<a href="shebeishenqingList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
