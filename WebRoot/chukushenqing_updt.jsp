...
function gows()
{
	document.location.href="chukushenqing_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateChukushenqing.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改出库申请<input type="hidden" name="id" value="${chukushenqing.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bianhao.value='${chukushenqing.bianhao}';</script>	<script language="javascript">document.form1.shebeimingcheng.value='${chukushenqing.shebeimingcheng}';</script>	<script language="javascript">document.form1.shenqingshuliang.value='${chukushenqing.shenqingshuliang}';</script>	<script language="javascript">document.form1.shenqingyuanyin.value='${chukushenqing.shenqingyuanyin}';</script>	<script language="javascript">document.form1.shenqingren.value='${chukushenqing.shenqingren}';</script>	
					 </table>
			</form>
   </body>
</html>
