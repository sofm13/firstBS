...
function gows()
{
	document.location.href="shebeiruku_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateShebeiruku.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改设备入库<input type="hidden" name="id" value="${shebeiruku.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bianhao.value='${shebeiruku.bianhao}';</script>	<script language="javascript">document.form1.shebeimingcheng.value='${shebeiruku.shebeimingcheng}';</script>	<script language="javascript">document.form1.kucun.value='${shebeiruku.kucun}';</script>	<script language="javascript">document.form1.shenqingshuliang.value='${shebeiruku.shenqingshuliang}';</script>	
					 </table>
			</form>
   </body>
</html>
