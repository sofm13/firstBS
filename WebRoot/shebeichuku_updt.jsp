...
function gows()
{
	document.location.href="shebeichuku_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateShebeichuku.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改设备出库<input type="hidden" name="id" value="${shebeichuku.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bianhao.value='${shebeichuku.bianhao}';</script>	<script language="javascript">document.form1.shebeimingcheng.value='${shebeichuku.shebeimingcheng}';</script>	<script language="javascript">document.form1.kucun.value='${shebeichuku.kucun}';</script>	<script language="javascript">document.form1.shenqingshuliang.value='${shebeichuku.shenqingshuliang}';</script>	
					 </table>
			</form>
   </body>
</html>
