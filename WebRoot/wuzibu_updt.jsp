...
function gows()
{
	document.location.href="wuzibu_add.jsp?id=<%=id%>";
}
	...
	<body>
			<form action="updateWuzibu.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.zhanghao.value='${wuzibu.zhanghao}';</script>	<script language="javascript">document.form1.mima.value='${wuzibu.mima}';</script>	<script language="javascript">document.form1.xingming.value='${wuzibu.xingming}';</script>	<script language="javascript">document.form1.bumenmingcheng.value='${wuzibu.bumenmingcheng}';</script>	<script language="javascript">document.form1.gangwei.value='${wuzibu.gangwei}';</script>	<script language="javascript">document.form1.lianxidianhua.value='${wuzibu.lianxidianhua}';</script>	<script language="javascript">document.form1.shouji.value='${wuzibu.shouji}';</script>	<script language="javascript">document.form1.jiatingdizhi.value='${wuzibu.jiatingdizhi}';</script>	
					 </table>
			</form>
   </body>
</html>
