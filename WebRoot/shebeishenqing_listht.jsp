...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="shebeishenqingListht.do" name="myform" method="post">
    ...
    <td align='center'>${u.issh} <input type="button" value="审核" onClick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=shebeishenqing'"/></td>
                              ...
                              <td align="center"><a href="hetongshengcheng_add.jsp?id=${u.id}">合同制作</a> <a href="shebeishenqingDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="shebeishenqingListht.do?page=1" >首页</a>
             <a href="shebeishenqingListht.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shebeishenqingListht.do?page=${page.page+1 }">下一页</a>
			<a href="shebeishenqingListht.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
