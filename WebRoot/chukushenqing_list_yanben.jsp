...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="chukushenqingList.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.bianhao}</td>    <td>${u.shebeimingcheng}</td>    <td>${u.shenqingshuliang}</td>        <td>${u.shenqingren}</td>    <td align='center'>${u.issh} <input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=chukushenqing'"/></td>
                              ...
                              <td align="center"> <!--lianjie1--> <a href="chukushenqingDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="chukushenqingList.do?page=1" >首页</a>
             <a href="chukushenqingList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="chukushenqingList.do?page=${page.page+1 }">下一页</a>
			<a href="chukushenqingList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
