...
function gows()
{
	document.location.href="shebeichuku_add.jsp?id=<%=id%>&bianhao="+document.form1.bianhao.value;
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addShebeichuku.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加设备出库</td>
						</tr>
