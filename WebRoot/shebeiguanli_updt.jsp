...
function gows()
{
	document.location.href="shebeiguanli_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateShebeiguanli.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改设备管理<input type="hidden" name="id" value="${shebeiguanli.id}" /></td>
						</tr>
						<tr ><td width="200">编号：</td><td><input name='bianhao' type='text' id='bianhao' value='' onblur='hsgcheck()' style='border:solid 1px #000000; color:#666666' />&nbsp;*<label id='clabelbianhao' /></td></tr>		<tr ><td width="200">设备名称：</td><td><input name='shebeimingcheng' type='text' id='shebeimingcheng' value='' onblur='checkform()' style='border:solid 1px #000000; color:#666666' />&nbsp;*<label id='clabelshebeimingcheng' /></td></tr>		<tr ><td width="200">库存：</td><td><input name='kucun' type='text' id='kucun' value='' onblur='checkform()' style='border:solid 1px #000000; color:#666666' />&nbsp;*<label id='clabelkucun' /></td></tr>		<tr ><td width="200">设备详情：</td><td><textarea name='shebeixiangqing' cols='50' rows='5' id='shebeixiangqing' onblur='' style='border:solid 1px #000000; color:#666666' ></textarea></td></tr>		
						...
						<script language="javascript">document.form1.bianhao.value='${shebeiguanli.bianhao}';</script>	<script language="javascript">document.form1.shebeimingcheng.value='${shebeiguanli.shebeimingcheng}';</script>	<script language="javascript">document.form1.kucun.value='${shebeiguanli.kucun}';</script>	<script language="javascript">document.form1.shebeixiangqing.value='${shebeiguanli.shebeixiangqing}';</script>	
					 </table>
			</form>
   </body>
</html>
