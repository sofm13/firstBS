...
function gows()
{
	document.location.href="baofeishenqing_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateBaofeishenqing.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">修改报废申请<input type="hidden" name="id" value="${baofeishenqing.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.bianhao.value='${baofeishenqing.bianhao}';</script>	<script language="javascript">document.form1.shebeimingcheng.value='${baofeishenqing.shebeimingcheng}';</script>	<script language="javascript">document.form1.baofeiyuanyin.value='${baofeishenqing.baofeiyuanyin}';</script>	<script language="javascript">document.form1.baofeishuliang.value='${baofeishenqing.baofeishuliang}';</script>	<script language="javascript">document.form1.baofeiren.value='${baofeishenqing.baofeiren}';</script>	
					 </table>
			</form>
   </body>
</html>
