...
function gows()
{
	document.location.href="shebeishenqing_add.jsp?id=<%=id%>&bianhao="+document.form1.bianhao.value;
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addShebeishenqing.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="20" colspan="2" background="images/table_header.gif">添加设备申请</td>
						</tr>
		...
		<tr style='display:none'><td width="200">拒绝原因：</td><td><input name='jujueyuanyin' type='text' id='jujueyuanyin' value='' onblur='' style='border:solid 1px #000000; color:#666666' /></td></tr>
