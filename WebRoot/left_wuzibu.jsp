...
<dl class="custom">
			...
			<dd><a href="doUpdateWuzibu2.do" target="hsgmain">修改个人资料</a></dd>
...
<dd><a href="shebeichukuList.do" target="hsgmain">设备出库查询</a></dd>
		...
		<dl class="custom">
			...
			<dd><a href="jianyijihua_add.jsp" target="hsgmain">建议计划添加</a></dd>
<dd><a href="jianyijihuaList2.do" target="hsgmain">建议计划查询</a></dd>
		</dl>
		<dl class="custom">
			<dt onClick="changeImage()">维简计划管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="weijianjihua_add.jsp" target="hsgmain">维简计划添加</a></dd>
